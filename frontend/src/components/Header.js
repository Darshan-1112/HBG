...
const newsData = [
  { name: "Uprise", desc: "Solo partners with Uprise to enhance financial planning for solopreneurs." },
  { name: "IndeCollective", desc: "Solo and IndeCollective collaborate to support independent business growth." },
  { name: "Carry", desc: "Carry joins Solo to provide tailored tax and investment support." },
  { name: "Simply Business", desc: "Solo partners with Simply Business to offer specialized insurance solutions." },
  { name: "Wethos", desc: "Wethos and Solo collaborate to simplify client proposals and billing tools." },
  { name: "Grasshopper", desc: "Solo and Grasshopper team up to deliver virtual phone services for members." }
];
                    ...
                    <div className="col-12 col-lg-6 col-xl-4">
                      ...
                      <div className="news-box">
                        <div className="news-heading">
                          <div><img src="/images/news.png" alt="" /></div>
                          <div><h6>News</h6></div>
                        </div>

                        {/* Desktop Version (Pairs of 2) */}
                        <div className="owl-carousel owl-theme d-none d-md-block">
                          {[0, 2, 4].map((startIndex) => (
                            <div className="news-slide" key={startIndex}>
                              <div className="news-card">
                                <h3>{newsData[startIndex].name}</h3>
                                <p>{newsData[startIndex].desc}</p>
                              </div>
                              <div className="news-card">
                                <h3>{newsData[startIndex + 1].name}</h3>
                                <p>{newsData[startIndex + 1].desc}</p>
                              </div>
                            </div>
                          ))}
                        </div>

                        {/* Mobile Version (Single items) */}
