...
//  * AddMemberModal
//  * ─────────────────────────────────────────────────────────────────────────────
//  * Pure React component — zero DOM manipulation, no window/document access.
//  * All state is managed via useState; visibility is controlled by the parent
//  * (page.js) via conditional rendering (`{showModal && <AddMemberModal />}`).
//  *
//  * Props:
//  *   closeModal  — () => void  — hides the modal (parent sets showModal=false)
//  *   onSave      — (data) => void — called with family data on Continue
//  *   quoteData   — object — passed through to the save payload
//  * ─────────────────────────────────────────────────────────────────────────────
//  */
