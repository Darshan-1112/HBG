...
//       hsScript.id = "hs-forms-script";
//       hsScript.src = "//js.hsforms.net/forms/embed/v2.js";
//       hsScript.charset = "utf-8";
//       hsScript.type = "text/javascript";
//       hsScript.onload = initHubSpot;
...
//         /* KEY FIX: force white on all footer anchor tags */
...
//           padding: 10px 14px !important; width: 100% !important; font-size: 14px !important;
//         }
...
//           background-color: #fff !important; color: #1e2a6e !important;
...
//                   <li><Link href="https://hbgsolo.com/about-us" className="footer-link">About Us</Link></li>
//                   <li><Link href="https://hbgsolo.com/about-us#license" className="footer-link">Regulatory &amp; Licensing</Link></li>
//                   <li><Link href="https://hbgsolo.com/disclosure-statement" className="footer-link">Disclosure Statement</Link></li>
//                   <li><Link href="https://hbgsolo.com/privacy-policy-cookie-restriction-mode" className="footer-link">Privacy &amp; Cookie Policy</Link></li>
//                   <li><Link href="https://hbgsolo.com/terms-and-conditions" className="footer-link">Terms &amp; Conditions</Link></li>
...
//                 <ul className="footer-links-list">
//                   <li><Link href="https://hbgsolo.com/plan-summary" className="footer-link">Plan Summary</Link></li>
//                   <li><Link href="https://hbgsolo.com/faq" className="footer-link">Policy FAQ</Link></li>
//                   <li><Link href="https://hbgsolo.com/how-it-works" className="footer-link">How It Works</Link></li>
//                   <li><Link href="https://hbgsolo.com/contact#partner" className="footer-link">Partner Program</Link></li>
//                 </ul>
//               </div>
...
//                     <svg width="20" height="21" viewBox="0 0 20 21" fill="none"><path d="M18.7892 7.0143C18.9297 7.99791 19 8.96746 19 9.92296V11.2719L18.7892 14.1806C18.6768 14.9956 18.4379 15.5857 18.0726 15.9511 17.6792 16.3445 17.089 16.5974 16.3021 16.7099 15.5433 16.7661 14.63 16.8082 13.5621 16.8363 12.5222 16.8644 11.6651 16.8785 10.9906 16.8785H9.97892C6.85948 16.8504 4.82201 16.7942 3.86651 16.7099L3.52927 16.6677C3.30445 16.6396 3.12178 16.6115 2.98126 16.5834 2.84075 16.5553 2.65808 16.485 2.43326 16.3726 2.23653 16.2602 2.05386 16.1197 1.88525 15.9511 1.74473 15.7824 1.60422 15.5576 1.4637 15.2766 1.35129 14.9675 1.28103 14.7005 1.25293 14.4757L1.16862 14.1806C1.05621 13.197 1 12.2274 1 11.2719V9.92296L1.16862 7.0143C1.28103 6.19931 1.51991 5.60915 1.88525 5.24381 2.27869 4.82226 2.8829 4.56933 3.69789 4.48502 4.45667 4.42882 5.35597 4.38666 6.39578 4.35856 7.4356 4.33046 8.29274 4.31641 8.96721 4.31641H9.97892C12.5082 4.31641 14.6159 4.37261 16.3021 4.48502 17.089 4.56933 17.6792 4.82226 18.0726 5.24381 18.452 5.80587 18.733 6.69111 18.7892 7.0143ZM12.4239 10.7239L13.0141 10.4288 8.16628 7.89954V12.9581L12.4239 10.7239Z" fill="white" /></svg>
//                   </Link>
...
// ─────────────────────────────────────────────────────────────────────────────
// Footer with reliable HubSpot form embed.
// Fix: poll for hbspt with retries so it works even when the script loads
// after React hydration. Also adds the HubSpot script tag itself if missing.
// ─────────────────────────────────────────────────────────────────────────────
