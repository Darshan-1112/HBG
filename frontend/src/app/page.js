...
//     if (!quoteZip || !quoteDob || !quoteGender) {
//     alert("Please fill in your Zip Code, Date of Birth, and Gender.");
//     return;
//   }
...
//   if (bannerLink) {
//     bannerLink.addEventListener("click", handleFaqBannerClick);
//     return () => bannerLink.removeEventListener("click", handleFaqBannerClick);
//   }
// }, [handleFaqBannerClick]);
...
//             {/* Mobile Slider */}
//             <div className="custom-slider d-block d-lg-none" onTouchStart={handleCoverageTouchStart} onTouchEnd={handleCoverageTouchEnd}>
    ...
    <>
      ...
      <section className="hero-section" data-aos="fade-zoom-out" data-aos-duration="3000">
        ...
        <div className="stats-section">
          <div className="custom-container">
            <div className="d-flex flex-column flex-md-row gap-3">
              <div className="stats-card shadow" data-aos="fade-up" data-aos-delay="200"><div><h2 className="counter">2,000+</h2><p className="label">SELF-EMPLOYED</p><span>Businesses &amp; Growing</span></div></div>
              <div className="stats-card shadow" data-aos="fade-up" data-aos-delay="400"><div><h2 className="counter">$4.2+</h2><p className="label">MILLION</p><span>In Collective Member Savings</span></div></div>
              <div className="stats-card shadow" data-aos="fade-up" data-aos-delay="600"><div><h2 className="counter">1M+</h2><p className="label">IN-NETWORK</p><span>Healthcare Practitioners Nationwide</span></div></div>
            </div>
          </div>
        </div>
        <section className="stats-carousel">
            ...
            <div data-aos="fade-up" data-aos-easing="linear" data-aos-offset="200" data-aos-duration="1500">
              <div className="row g-5 M-32">
                {COVERAGE_TILES.map(([img, title, desc], i) => (
                  <div className="col-12 col-md-6 col-lg-4" key={i}>
                    <div className="coverage-tiles">
                      <div className="tile-image"><img src={`/images/${img}`} alt={title} /></div>
                      <div><p className="tiles-title">{title}</p><p className="tiles-subtitle">{desc}</p></div>
                    </div>
                  </div>
                ))}
